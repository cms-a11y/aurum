import { P as ProductCarousel, a as ProductStickyForm, b as ProductMediaScroller, c as ProductForm } from "./product-sticky-form-522b90c6.js";
...
const ProductSection = (section) => {
  ...
  const drawersSelectors = {
    ...
    customDrawer5: `productDrawer5-${sectionId}`,
    customDrawer6: `productDrawer6-${sectionId}`
  };
  let Carousel = null;
  function init2() {
  ...
  function setDrawers() {
    try {
      ...
      setToggleDrawer(drawersSelectors.customDrawer5);
      setToggleDrawer(drawersSelectors.customDrawer6);
    } catch (e) {
    }
  }
